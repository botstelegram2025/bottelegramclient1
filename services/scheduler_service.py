...
class SchedulerService:
    ...
    def _check_reminder_times(self):
            """Dispara lembretes no horário programado de cada usuário (fuso São Paulo, 1x por dia)."""
            try:
                ...
                with db_service.get_session() as session:
                    # Usuários ativos com (ou sem) configuração
                    ...
                    for user, settings in users_settings:
                        ...
                        # Parse horário do lembrete diário
                        try:
    ...
    """
        ...
        def _check_trial_expiration(self, user, current_date):
            ...
            try:
                ...
                trial_end_date = (user.trial_end_date.date() if getattr(user, 'trial_end_date', None) else user.created_at.date() + timedelta(days=7))
